      ...
      {isFullSize => {
        ...
        return isPlayerOnly ? (
          ...
          <Box className={styles.pageWrapper} dir={isRtl ? 'rtl' : 'ltr'} {...componentProps}>
            ...
            {backdropLibraryVisible ? <BackdropLibrary vm={vm} onRequestClose={onRequestCloseBackdropLibrary} /> : null}
            {/* <MenuBar
            ...
            <Box className={styles.bodyWrapper}>
              <Box className={styles.flexWrapper}>
                ...
                <Box className={classNames(styles.stageAndTargetWrapper, styles[stageSize])}>
                  <StageWrapper isRendererSupported={isRendererSupported} isRtl={isRtl} stageSize={stageSize} vm={vm} />
